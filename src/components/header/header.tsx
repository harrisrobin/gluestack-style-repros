...
import { isRTL, translate } from "../../services/i18n"
import {
  ExtendedEdge,
  useSafeAreaInsetsStyle,
} from "../screen/use-safe-area-insets-style"
import { useToken } from "@gluestack-style/react"
import { useRouter } from "expo-router"
import { HORIZONTAL_CONTENT_PADDING_TOKEN } from "@/constants/ui"
...
export function Header(props: HeaderProps) {
  const backgroundColorToken = useToken("colors", "backgroundColorLight")
  ...
  return (
    <View
      ...
      <View
        style={[styleOverride]}
        sx={{
          paddingHorizontal: HORIZONTAL_CONTENT_PADDING_TOKEN,
          height: 56,
          flexDirection: "row",
          alignItems: "center",
  ...
  if (icon) {
    return (
      <Pressable
        ...
        <Icon size={28} icon={icon} color={iconColor} />
      </Pressable>
    )
  }
